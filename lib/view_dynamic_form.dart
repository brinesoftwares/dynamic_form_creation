...
class ViewDynamicForm extends StatefulWidget {
  final List? apiWidget;

  const ViewDynamicForm({Key? key, @required this.apiWidget}) : super(key: key);

  @override
  _ViewDynamicFormState createState() => _ViewDynamicFormState();
}

class _ViewDynamicFormState extends State<ViewDynamicForm> {
